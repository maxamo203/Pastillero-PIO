...
action state_table_action[MAX_STATES][MAX_EVENTS] = {
    ...
    {scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, scanning, none, none, none, none, none, none, none, none, pillDetected, noPillDetected, none},                         /*ST_SCANNING_AT_PILL_POS*/
